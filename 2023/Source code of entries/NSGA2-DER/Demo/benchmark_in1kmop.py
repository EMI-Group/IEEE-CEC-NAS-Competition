...
class In1KMOPProblem(Problem):
    def __init__(self,
        ...
        super().__init__(n_var=benchmark.search_space.n_var,
                         ...
                         n_constr=0,
                         xl=np.array(benchmark.search_space.lb),
                         xu=np.array(benchmark.search_space.ub),
...
if __name__ == '__main__':
    ...
    parser.add_argument('--moea', type=str, default='nsga2', choices=['nsga2', 'moead', 'nsga3'],
                        help='which MOEA to run')
    ...
    for pid in range(1, 10):
        ...
        with open('EXP/in1kmop{}_{}.json'.format(pid, args.moea), 'w') as fp:
