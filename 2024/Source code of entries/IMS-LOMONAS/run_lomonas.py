...
def main(kwargs):
    ...
    for r in tqdm(range(1, kwargs.runs + 1)):
        ...
        algo = LOMONAS(k=kwargs.k,
                       neighborhood_check_on_potential_sols=True,
                       check_limited_neighbors=True, alpha=kwargs.alpha,
                       evaluator=evaluator, debugger=debugger)
...
if __name__ == '__main__':
    ...
    ''' ALGORITHM '''
    parser.add_argument('--k', type=int, default=3, help='#kept front for neighborhood check (LOMONAS)')
