...
if __name__ == "__main__":
    ...
    parser.add_argument("--pid", type=int, default=1, help="which problem to solve")
    ...
    parser.add_argument('--res_path', type=str, default='./exp')
    args = parser.parse_args()

    database_path, data_path = args.database_path, args.data_path
    ...
    for r in range(1, args.runs + 1):
        ...
        res = minimize(problem, algorithm, ("n_eval", 10000), seed=seed, verbose=False)
    ...
    with open('{}/citysegmop{}_{}.json'.format(args.res_path, pid, args.moea), 'w') as fp:
