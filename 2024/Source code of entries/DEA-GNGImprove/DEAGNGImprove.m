classdef DEAGNGImprove < ALGORITHM
...
%--------------------------------------------------------------------------
    ...
    methods
        function main(Algorithm,Problem)
            ...
            [FrontNo,~]    = EpsilonSort(Population.objs,Problem.N,Problem); % Fitness for the first mating selection
            ...
            while Algorithm.NotTerminated(Population)        
                ...
                if ceil(Problem.FE/Problem.N) <= MaxGen - NoG   
                    ...
                    AS = ArchiveUpdate([AS;Offspring.objs],ArchiveSize,Ruq,GNGnet.NodeS,Zmin,Problem);
                    nAS = length(AS);      
               ...
               [Population,FrontNo,crd] = ESelection([Population,Offspring],Problem.N,Ruq,GNGnet.NodeS,theta,Zmin,Problem);
